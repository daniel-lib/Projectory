-- INSERT USERS
insert into USERS (username, password, first_name, last_name, email_address) values ('testuser1', 'testuser123', 'Test', 'User1', 'test1@user.com');
insert into USERS (username, password, first_name, last_name, email_address) values ('testuser2', 'testuser123', 'gebru', 'User2', 'gebru@user.com');
insert into USERS (username, password, first_name, last_name, email_address) values ('testuser3', 'testuser123', 'semhal', 'User3', 'semhal@user.com');
insert into USERS (username, password, first_name, last_name, email_address) values ('hena', '123456', 'henok', 'sertse', 'hena_s@user.com');
insert into USERS (username, password, first_name, last_name, email_address) values ('hawa2', 'pasw1', 'hewan', 'john', 'hewi2@user.com');
insert into USERS (username, password, first_name, last_name, email_address) values ('markos55', 'inthe24', 'mark', 'os', 'mark_os2@user.com');
